	...
	<div data-role="header" data-theme="c">
		<h2>Vänner</h2>
			...
			<div data-role="navbar">
				<ul>
					<li><a href="<?php echo site_url('friends'); ?>" data-transition="fade" data-inline="true" class="ui-btn-active ui-state-persist">Lista</a></li>
					<li><a href="<?php echo site_url('friends/add'); ?>" data-transition="fade" data-inline="true">Ny vän</a></li>
