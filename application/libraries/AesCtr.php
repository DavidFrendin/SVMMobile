...
class AesCtr
{
  ...
  public static function encrypt($plaintext, $password, $nBits) {
    ...
    $key = AesCtr::cipher($pwBytes, AesCtr::keyExpansion($pwBytes));
    ...
    $keySchedule = AesCtr::keyExpansion($key);
    //print_r($keySchedule);
    ...
    for ($b=0; $b<$blockCount; $b++) {
      ...
      $cipherCntr = AesCtr::cipher($counterBlock, $keySchedule);  // -- encrypt counter block --
